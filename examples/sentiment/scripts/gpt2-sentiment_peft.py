...
ref_model.config = ref_model.pretrained_model.config # We should change the AutoModelForCausalLMWithValueHead to have a config property 
ref_model.prepare_inputs_for_generation = ref_model.pretrained_model.prepare_inputs_for_generation # Again, this is required by LoRA, perhaps we also all this method to AutoModelForCausalLMWithValueHead?
