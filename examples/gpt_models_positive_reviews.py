...
parser.add_argument(
    ...
    type=str,
    help="Which model to use for the ",
)
...
wandb.init(name=config["model_name"], project='benchmark_gpt_model', config=config,)
...
gpt2_model_ref = AutoModelForCausalLM.from_pretrained(config['model_name'])
